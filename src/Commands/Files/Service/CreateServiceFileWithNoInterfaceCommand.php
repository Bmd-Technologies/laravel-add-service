...
final class CreateServiceFileWithNoCInterfaceCommand extends GeneratorCommand
{
    /**
     * @var string
     */
    protected $name = 'make:servicewithnointerface';
    ...
    {
        return __DIR__.'/../../../../stubs/service-without-interface.stub';
    }
